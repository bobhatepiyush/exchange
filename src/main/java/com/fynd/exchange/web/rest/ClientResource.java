...
import com.fynd.exchange.repository.ClientRepository;
...
/**
 * REST controller for managing {@link com.fynd.exchange.domain.Client}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Client> result = clientRepository
            ...
            .map(existingClient -> {
                ...
                if (client.getSecretKey() != null) {
                    existingClient.setSecretKey(client.getSecretKey());
                }
