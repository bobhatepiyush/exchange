...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().name(DEFAULT_NAME).secretKey(DEFAULT_SECRET_KEY).isActive(DEFAULT_IS_ACTIVE);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().name(UPDATED_NAME).secretKey(UPDATED_SECRET_KEY).isActive(UPDATED_IS_ACTIVE);
        return client;
    }
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getSecretKey()).isEqualTo(DEFAULT_SECRET_KEY);
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.name(UPDATED_NAME).secretKey(UPDATED_SECRET_KEY).isActive(UPDATED_IS_ACTIVE);
        ...
        assertThat(testClient.getSecretKey()).isEqualTo(UPDATED_SECRET_KEY);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.name(UPDATED_NAME).secretKey(UPDATED_SECRET_KEY).isActive(UPDATED_IS_ACTIVE);
